<?php
$app->post('/api/DropboxBusiness/addGroupMember', function ($request, $response, $args) {
    ...
    $query_str = $settings['api_url'] . "2/team/groups/members/add";
    $body = array();

    $body['group']['.tag'] = 'group_id';
    $body['group']['group_external_id'] = $post_data['args']['groupId'];
    $body['members'][]['user']['.tag'] = $post_data['args']['memberIdType'];
    $body['members'][]['user'][$post_data['args']['memberIdType']] = $post_data['args']['memberId'];
