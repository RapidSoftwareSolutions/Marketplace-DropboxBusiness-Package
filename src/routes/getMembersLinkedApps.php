<?php
$app->post('/api/DropboxBusiness/getMembersLinkedApps', function ($request, $response, $args) {
    ...
    $query_str = $settings['api_url'] . "2/team/linked_apps/list_members_linked_apps";
    $body = array();
