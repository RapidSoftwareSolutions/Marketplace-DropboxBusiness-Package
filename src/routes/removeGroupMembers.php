<?php
$app->post('/api/DropboxBusiness/removeGroupMembers', function ($request, $response, $args) {
    $settings = $this->settings;

    //checking properly formed json
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['accessToken', 'groupId', 'users']);
    ...
    $body['users'] = $post_data['args']['users'];
